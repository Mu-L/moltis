...
The vault initializes during first-time setup, unseals automatically on
login, and re-seals on server restart. A recovery key is provided at
initialization for emergency access.
